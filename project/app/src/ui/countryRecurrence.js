...
export function createCountryRecurrence(container, ctx) {
  ...
  const svg = select(container).append('svg').attr('role', 'img')
    .attr('aria-label', 'Country-by-year matrix of impact records from 2005 to 2023; dot fill encodes the reported impact strength');
  ...
  function render(state) {
    ...
    for (const year of compact ? [2005, 2015, 2023] : [2005, 2010, 2015, 2020, 2023]) {
